...
//+kubebuilder:webhook:path=/mutate-view-whisffee-net-v1-markdownview,mutating=true,failurePolicy=fail,sideEffects=None,groups=view.whisffee.net,resources=markdownviews,verbs=create;update,versions=v1,name=mmarkdownview.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-view-whisffee-net-v1-markdownview,mutating=false,failurePolicy=fail,sideEffects=None,groups=view.whisffee.net,resources=markdownviews,verbs=create;update,versions=v1,name=vmarkdownview.kb.io,admissionReviewVersions=v1
